...
;(function ( $, window, document, undefined ) {
    ...
    var pluginName = "sGallery",
        ...
        bigSelector = 'ul:eq(1)',
        smallSelector = 'ul:eq(0)';

    function Plugin( element, options ) {
        this.element = element;
        this.galleryContainer = $(this.element);
        this.bigItemsList = this.galleryContainer.children(bigSelector);
    ...
    Plugin.prototype = {
        ...
        init: function() {
            var that = this,
                smallItems = this.galleryContainer.find(smallSelector),
        ...
        fadeAllOut: function(){
            this.galleryContainer.children(smallSelector)
                     .children('li')
        ...
        fadeAllIn: function(){
            var that = this;
            var dropZone = this.galleryContainer.children(smallSelector).children('li:eq(' + that.current + ')');
            this.galleryContainer.children(smallSelector)
                     .children('li')
                     .not(dropZone)
        ...
        quitSlideShow: function(test) {
            ...
            var currentImg = this.galleryContainer.children(bigSelector).children('li:eq(' + that.current + ')'),
                  dropZone = this.galleryContainer.children(smallSelector).children('li:eq(' + that.current + ')'),
